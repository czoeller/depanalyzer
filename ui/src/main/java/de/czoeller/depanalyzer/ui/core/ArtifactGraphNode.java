...
public class ArtifactGraphNode {
    ...
    public DependencyNode getArtifact() {
        return artifact;
    }
    ...
    @Nullable
    DependencyNode getArtifactParent(@Nonnull Graph<ArtifactGraphNode, ?> graph) {
        ArtifactGraphNode parent = Iterables.getFirst(graph.getPredecessors(this), null);
        if (parent != null) {
            setArtifactParent(parent.getArtifact());
